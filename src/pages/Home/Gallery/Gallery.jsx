...
const Gallery = () => {
  const images = [`${img1}`, `${img12}`, `${img17}`, `${img4}`, `${img14}`, `${img6}`, `${img19}`, `${img16}`, `${img9}`, `${img10}`, `${img11}` , `${img2}`, `${img13}`, `${img5}`, `${img15}`, `${img8}`, `${img18}`, `${img20}`, `${img7}`, `${img3}`];
  ...
  return (
    <div className="my-5 ">
      ...
      <div className="overflow-hidden h-96 hover:overflow-y-auto">
